...
import 'package:yurbancustomers/Models/ConstituenciesModel.dart';
import 'package:yurbancustomers/Models/CountiesModel.dart';
  ...
  void _togglePinVisibility() {
   ...
   Future<void> _register() async {
    ...
    final response = await http.post(
      Uri.parse(BaseURL.REGISTER_CUSTOMER),
      headers: {
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        suffixIcon: IconButton(
          icon: Icon(
            _isPinVisible ? Icons.visibility : Icons.visibility_off,color: Colors.redAccent, 
          ),
